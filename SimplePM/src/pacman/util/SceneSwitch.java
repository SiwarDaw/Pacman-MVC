...
public enum SceneSwitch {
  ...
  public void switchToHome() {
    try {
      ...
      URL url = new File(ResourcesFileName.SYSTEM_PATH+ResourcesFileName.MAIN_WINDOW_FXML_PATH).toURI().toURL();
  ...
  public void switchToMenu() {
    try {
      ...
      URL url = new File(ResourcesFileName.SYSTEM_PATH+ResourcesFileName.MENU_WINDOW_FXML_PATH).toURI().toURL();
      Parent root = FXMLLoader.load(url);
      Scene scene = new Scene(root);
      setScene(scene);
  ...
  public void switchToGame(GameMap map) {
    try {
      ...
      URL url = new File(ResourcesFileName.SYSTEM_PATH+ResourcesFileName.VIEW_GAME_FXML_PATH).toURI().toURL();
